		...
		<SiteLayout>
			...
			<ContentContainer className="">
				...
				<div className="FeaturedProjects__wrapper mb-5">
					<Link href={`https://camplete.com.au`} target="_blank" className="FeaturedProject mb-4 mb-md-0 border">
						<video
							controls={false}
							autoPlay={true}
							loop
					...
					<Link href={'https://openinvest.com.au'} target="_blank" className="FeaturedProject mb-4 mb-md-0 border">
						<OILogo />
						<span className="FeaturedProject__info"></span>
					</Link>
				</div>
				<div className="text-center">
					<Link href={LINKS.GITHUB} className="btn btn-outline-primary d-inline-flex align-items-center">
				...
				<div className="row">
					<div className="col-12 col-lg-6 d-flex flex-column justify-content-center mb-5 mb-lg-0">
						<div>
							<h2>About me</h2>
							<p>
								With around {getYearsExperience()} years experience in software development I have a wealth of experience
								dealing with complex problems and implementing solutions. I&apos;m a frontend engineer first and foremost,
								however I do have experience with building backend systems, UX design, and an understanding of CI/CD pipelines.
							</p>
							<p className="mb-5">
