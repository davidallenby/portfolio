				...
				<div className="contained gutter-x">
					<div className="row">
						...
						<div className="col-12 col-md-6">
							<h1>Hi, I&apos;m David</h1>
							<p>
								I&apos;m a Lead Frontend Developer with about 12 years of hands-on experience in the tech industry. Although
								I&apos;m completely self-taught, I&apos;ve worked across a variety of environments, from big financial
								institutions to agile startups and creative digital agencies. This diverse background has made me adaptable and
								skilled at delivering high-quality solutions tailored to different project needs
							</p>
							<p>
								Over the years, I&apos;ve had the chance to work on a wide range of projects in various sectors. Working with
								large financial institutions has given me a strong focus on security and performance, making sure the
								applications I build are solid and reliable. Meanwhile, my experience with startups and digital agencies has
								fine-tuned my ability to develop quickly and solve problems creatively, helping to bring fresh ideas to life
								efficiently.
							</p>
						</div>
					</div>
			...
			<ContentContainer className="bg-white">
				<div className="row">
					<div className="col-12 col-lg-6 mb-4 mb-lg-0">
						<h2>My toolkit</h2>
						<p>
							I&apos;ve had the opportunity to gain experience and knowledge with the following tools, languages, and
							frameworks.
						</p>
						<p>
							While I am a frontend developer first and foremost, I have had the opportunity to dive in to some backend
							development. Working with .NET Core web apps, and building frontend interfaces in Blazor. I have also built
				...
				<div className="row flex-row-reverse">
					<div className="col-12 col-lg-6 mb-5 mb-lg-0">
						...
						<p>
							...
							of Melbourne, Australia. Recently, I took the plunge and went traveling for a well earned extended break.
							I&apos;m now ready to get back to it and I&apos;m looking for my next opportunity.
						</p>
						<p>
					...
					<div className="col-12 col-lg-6 AboutMe__img-grid">
						<div>
							<Image src={'/images/tv-tower.jpg'} alt="Berlin TV Tower" width={600} height={600} className="img-fluid" />
						</div>
						<div>
							<Image
						...
						<div>
							<Image src={'/images/me-forest.jpg'} alt="Berlin TV Tower" width={600} height={600} className="img-fluid" />
						</div>
					</div>
				</div>
			</ContentContainer>
