...
const MobileNavContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }: any) => {
	...
	return <MobileNavContext.Provider value={{ open, toggleOpen }}>{children}</MobileNavContext.Provider>;
};
