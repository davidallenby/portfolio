...
const Chip: FC<ChipProps> = ({ className, children, icon, small, onDismiss, onClick, toggle }) => {
	...
	return (
		...
		>
			...
			{onDismiss && (
				<button type="button" className="Chip__dismiss ms-3 p-0 border-0 bg-transparent" onClick={onDismiss}>
					<MdClose size={14} />
				</button>
			)}
		</div>
