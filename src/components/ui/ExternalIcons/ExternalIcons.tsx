...
const ExternalIcons: FC<ExternalIconsProps> = ({ className, colorInverted = false }) => {
	/**
	...
	return (
		<div className={setStyleClass()}>
			<Link href="https://github.com/davidallenby" rel="noreferrer" target="_blank" className="me-4">
				<BsGithub fontSize={20} />
			</Link>
			<Link href="https://www.linkedin.com/in/davidallenby/" rel="noreferrer" target="_blank" className="me-4">
				<BsLinkedin fontSize={20} />
			</Link>
			<Link href="https://codepen.io/davidallenby" rel="noreferrer" target="_blank" className="me-4">
