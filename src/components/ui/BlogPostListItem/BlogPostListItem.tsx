...
const BlogPostListItem: FC<BlogPostListItemProps> = ({
  ...
  return (
    <div
      className='BlogPostListItem py-4 flex flex-wrap flex-sm-nowrap lg:flex-wrap flex-xl-nowrap flex-sm-row-reverse flex-row justify-content-between'
      tabIndex={0}
      onClick={openPostUrl}
    >
        ...
        <p className='mb-2'>
          <small>
            {loading ? (
              ...
              getDateString(post.dateCreated)
            )}
          </small>
        </p>
        {loading ? (
