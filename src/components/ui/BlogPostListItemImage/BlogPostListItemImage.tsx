...
const BlogPostListItemImage: FC<BlogPostListItemImageProps> = ({ href, src, loading = false }) => {
	...
	return (
		<Link href={href} className="BlogPostListItemImage d-block position-relative mb-4 mb-sm-0 mb-lg-4 mb-xl-0">
			{loading ? <Skeleton width={'100%'} height={'100%'} /> : <Image width={height} height={width} src={src} alt="" />}
		</Link>
	);
};
