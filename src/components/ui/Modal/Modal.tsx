...
const Modal: FC<ModalProps> = ({ show, title, onClose, children, cancelBtnLabel = 'Cancel' }) => {
		...
		<>
			{open && (
				<div className={styleClass} onClick={(e) => onClose(false)}>
					<div
						className="Modal__body position-absolute w-100 d-flex flex-column flex-grow-1"
					...
					>
						...
						<div className="Modal__footer text-end p-3 border-top">
							<button type="button" className="btn btn-outline-primary" onClick={() => onClose(false)}>
